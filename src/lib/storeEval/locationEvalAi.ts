...
const FIELD_SCHEMAS: Record<LocationEvalFieldKey, ReturnType<typeof scoreProp> | ReturnType<typeof enumProp> | ReturnType<typeof textProp>> = {
  ...
  specialDemandType: enumProp(
    ...
    "특수수요유형 — 인구통계에 안 잡히는 이용자를 데려오는 수요원. '대학가'는 학부 중심 종합대학(재학생 1만 명 이상)의 " +
      "정문·후문 도보 500m 안에 있고 학생 원룸촌이 배후지를 이룰 때만. 대학원·약대·의대 단독 캠퍼스, 연구단지, 보건의료 " +
      "행정타운, 전문대 소규모 캠퍼스는 대학가가 아니라 '기타' 또는 '없음'. " +
      "'군부대'는 사단 예하 보병 연대·신병교육대·훈련소처럼 병사가 많고 외출·외박이 잦은 부대의 정문에서 걸어서 1km 안일 때만 — " +
      "사령부·특수부대·공군 비행단은 간부 중심이라 군부대가 아니다('없음' 또는 '기타'). " +
      "'산업단지'는 산단 정문 생활권(도보권)에 근로자 기숙사·원룸이 있는 공장 근로자 상권. 산단이 2~3km 밖이고 퇴근 근로자가 번화가로 오는 곳은 " +
      "산업단지가 아니라 '관광유흥'이다(그 근로자는 유동인구에 이미 있다). " +
      "'관광유흥'은 술집·노래방·유흥업소가 밀집한 번화가 한복판(관광지·터미널·역세권 유흥가 포함). " +
      "'기타'는 혁신도시 공공기관 통근, 역세권 상업처럼 수요원은 있으나 위 넷이 아닐 때.",
  ),
  specialDemandIntensity: enumProp(
    SPECIAL_DEMAND_INTENSITIES,
    "특수수요강도 — '높음'은 그 수요원이 이 상권의 주된 손님층일 때만(대학가: 위 조건을 전부 충족하고 학생이 주 고객). " +
      "수요원이 있으나 규모가 작거나 매장에서 멀거나 학부 중심이 아니면 '보통', 미미하면 '낮음'. " +
      "산업단지 '높음'은 공장 생산직이 걸어오는 거리에 대규모 단지가 있어 근로자가 주 고객일 때(단지가 멀거나 사무·연구 중심이면 '보통'). " +
      "군부대 '높음'은 셋 다 맞을 때만: (1) 병사 많고 외출·외박 잦은 부대(사령부·특수부대·비행단은 탈락) (2) 정문에서 도보 1km 안 " +
      "(3) 로드뷰에 군인 정액제·군인 할인·휴가 병사 대상 모텔·당구장·PC방 밀집 표식. 유동 성비로는 못 가른다. " +
      "관광유흥 '높음'은 술집·모텔·클럽이 밀집한 유흥가 한복판이거나 관광지라 밤 손님·외지 방문객이 주 고객일 때(유흥가 언저리·아파트 상가는 '보통'). " +
      "유동 20대 비중이 높다고 대학가로 보지 말 것(유흥가도 젊다). " +
      "산식은 대학가·산업단지·군부대·관광유흥 배수를 '높음'에만 곱하므로, 확실하지 않으면 '보통'으로 둘 것 — 모르면 보통.",
  ),
...
const SYSTEM_PROMPT =
  ...
  "산업단지/높음 = 산단 정문 생활권에 근로자 기숙사·원룸(산단이 2~3km 밖이면 관광유흥으로) · " +
  "관광유흥/높음 = 유흥업소 밀집 번화가 한복판. 셋 이상 근거를 못 대면 '보통'. 부대·캠퍼스·산단 이름과 거리를 상권구조메모에 적을 것)\n" +
  "- 외부유입제한(없음/보통/강함)\n" +
  "- 상권구조메모(자유서술)\n\n" +
