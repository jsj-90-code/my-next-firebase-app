...
// 5) **개점 코호트 효과 — 상관을 볼 때 평가창 시점부터 통제해야 한다.**
//    평가창은 매장마다 오픈 후 12개월이라 2023-11 ~ 2026-06으로 퍼져 있다. 그래서 시점이
//    거의 모든 것과 붙는다: 총단가 r=0.789 · 상품몫 r=0.729 · PC몫 r=0.674 · 경쟁력점수 r=0.913.
//
//    그래서 "경쟁력점수가 상품몫을 r=0.713으로 설명한다"가 **착시였다** — 시점을 통제하면
//    0.170으로 무너진다(유의선 0.354 미만). 경쟁력점수와 시점이 사실상 같은 변수다.
//
