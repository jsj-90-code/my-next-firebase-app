...
const SYSTEM_PROMPT =
  ...
  "- 3개 섹션으로 나눠 씁니다.\n" +
  "  [상권] 배후수요와 상권성격을 서술하세요. [후보지]의 이름·주소는 다우오피스 게시글 자체에 " +
  "이미 나와 있으니 절대 다시 언급하지 마세요(예: '본 후보지는 ~에 위치하며' 같은 문장 금지). " +
  "특이사항(지하철 승하차인구·세대수·학생수 등)이 주어지면 상권의 기본 스펙으로 활용하세요.\n" +
  "  [경쟁] 경쟁력 비교 라벨(매우우위/우위/동등/열세/매우열세)을 그대로 써서 경쟁점 대비 어느 " +
  "수준인지 명확히 구분해서 서술하세요.\n" +
  "  [종합 의견] 상권수요 → 자사가 확보할 것으로 예상되는 수요 → 그 수요·예상 PC대수·시간당요금이 " +
  "반영되어 산정된 V62 최종예상월매출, 순서로 흐름이 이어지게 쓰세요(수요 규모가 매출로 이어지는 " +
  "근거를 보여주는 것이 목적입니다). 단, V62는 회귀예측모형이라 '가동률 X%' 같은 중간 계산 단계나 " +
  "구체적인 곱셈식은 존재하지 않으니 지어내지 마세요 — 위에 주어진 숫자들을 나열하며 자연스럽게 " +
  "이어 쓰는 것으로 충분합니다.\n" +
  "- [참고]에 나오는 예상가동률/수요확보율은 V62 최종예상월매출과는 다른 별도 계산(경쟁점 실가동" +
  "좌석 기반, 미검증)이므로 V62의 산출근거인 것처럼 섞어서 쓰지 마세요.\n" +
