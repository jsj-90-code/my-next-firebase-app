...
describe("computeCompetitorAppliedPcCount — 오픈예정 경쟁점 처리(2026-08-27)", () => {
  ...
  it("PC대수를 모르면 노후저경쟁력미조사와 동일하게 간략_기본대수(90)로 채운다", () => {
    expect(computeCompetitorAppliedPcCount({ totalPcCount: null, appliedPcCount: null, surveyLevel: null, investigationStatus: "오픈예정" })).toBe(90);
  });
});

describe("describeAppliedPcCountBasis (2026-08-31 신설 — 90대 추정값의 출처/메모 보존, 요청사항 5)", () => {
