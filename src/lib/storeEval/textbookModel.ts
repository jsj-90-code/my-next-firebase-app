...
export type TextbookParams = {
   ...
   *
   * ⚠️ **표본이 2~5곳이라 계수를 확정할 수준이 아니다.** 군부대·대학가도 방향만 믿는다.
...
export const DEFAULT_TEXTBOOK_PARAMS: TextbookParams = {
  ...
  // 아니다 — 조절판에서 돌려볼 것.
  specialDemandMultipliers: { "군부대": 2.25, "대학가": 1.45, "산업단지": 1.0, "기타": 1.0, "관광·유흥": 1.0, "관광유흥": 1.0, "없음": 1.0 },
  maxUtilization: 0.55,
};
