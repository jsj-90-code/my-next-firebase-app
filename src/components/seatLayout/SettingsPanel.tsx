    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
      <div className="app-card flex max-h-[90vh] w-full max-w-3xl flex-col rounded-2xl">
        <div className="flex items-center justify-between border-b border-black/[0.06] px-5 py-4 dark:border-white/[0.08]">
          <h2 className="text-lg font-semibold text-[#171310] dark:text-[#f2ede2]">사양 설정</h2>
          <button
            type="button"
            onClick={handleClose}
        ...
        <div className="flex-1 space-y-6 overflow-y-auto px-5 py-4">
          ...
          <section>
            <h3 className="mb-2 font-semibold text-[#171310] dark:text-[#f2ede2]">책상 탭 드롭다운</h3>
          ...
          <section>
            <h3 className="mb-2 font-semibold text-[#171310] dark:text-[#f2ede2]">PC 탭 드롭다운/기본값</h3>
              ...
              {ZONE_TYPES.map((t) => (
                <div key={t.key} className="rounded-xl border border-black/[0.06] dark:border-white/[0.08]">
                  <button
                    ...
                    className="flex w-full items-center justify-between px-3 py-2 text-left text-sm font-medium text-[#171310] dark:text-[#f2ede2]"
                  >
...
function OptionEditor({
  ...
  return (
    <div className="rounded-lg border border-black/[0.06] p-3 dark:border-white/[0.08]">
      <p className="text-sm font-medium text-[#5c5346] dark:text-[#c9bfae]">{label}</p>
      <div className="mt-2 flex flex-wrap gap-1.5">
        {options.map((opt) =>
          editingOpt === opt ? (
            ...
            <span
              key={opt}
              className="flex items-center gap-1 rounded-full bg-[#171310]/[0.06] px-2.5 py-1 text-xs text-[#5c5346] dark:bg-white/[0.08] dark:text-[#c9bfae]"
            >
              <button
                type="button"
