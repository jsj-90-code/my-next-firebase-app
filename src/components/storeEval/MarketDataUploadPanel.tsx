...
// ⚠️ 2026-09-26부터 화면에서 쓰지 않는다 — 후보지 기본정보 탭이 SGIS·소상공인365 자동 채우기 버튼으로 바뀌었다.
//    소상공인365 버튼은 스크래핑이라 사이트가 바뀌면 깨질 수 있어 **예비로 남겨 둔 것**이다. 되살리려면
//    커밋 a123024의 BasicInfoTab.tsx에서 <MarketDataUploadPanel …> 두 개와 import 두 줄을 그대로 가져오면 된다.
//    몇 달 동안 안 쓰면 이 파일·marketDataExtract.ts 붙여넣기 부분·그 시험을 지워도 된다(사용자 승인 후).
//
