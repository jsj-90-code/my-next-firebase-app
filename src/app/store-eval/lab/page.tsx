      ...
      <ol className="mt-3 space-y-3 text-[var(--sl-ink-soft)]">
        ...
        <li>
          ...
          <div className="mt-1 rounded border border-[var(--sl-line)] p-2">
            <div className="font-semibold">산업단지·기타는 2026-09-20에 껐습니다 (2차 가공)</div>
            <div className="mt-1">
            ...
            <div className="mt-1">
              군부대·대학가는 자를 고쳐도 값이 그대로여서 <b>진짜 신호</b>로 보고 남겼고, 산업단지·기타는
              사실상 1이라 껐습니다. 끄고 나니 기준점 3곳이 전부 배수 1.00이 되어
            ...
            <div className="mt-1">
              ⚠️ <b>표본이 2~5곳이라 군부대·대학가도 방향만 믿습니다.</b> 그리고 지금은 유형마다
              한 값을 곱하는데, <b>같은 군부대라도 규모가 다릅니다</b> — 병력·재학생·종사자 수
              자료가 생기면 곱셈이 아니라 <b>덧셈</b>으로 넣는 것이 맞습니다.
            </div>
          </div>
          <div className="mt-1">
