...
// 사용자 2026-09-25: 신뢰 불가는 뺀다 — 치즈(두 등록, 39.2 아님)·이로운('(현재)' 78.9 가짜)·발산역 브리즈(등록 둘)·구리 불독(3대 등록). 값은 비워 둔 상태.
const HOLD = new Set(["20240621415|치즈", "20231023405|이로운", "20251121428|브리즈PC방", "N015|불독PC방"]);
const out = [], skipped = [];
for (const x of m) {
